...
@section('content')
    <div class="container mt-4">
        ...
        <div class="mb-3 mt-3 text-center">
            <form action="{{ route('laporan.piutang') }}" method="GET" class="d-inline-block">
    ...
    <!-- Modal Input Piutang -->
    <div class="modal fade" id="inputPiutangModal" tabindex="-1" aria-labelledby="inputPiutangModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="inputPiutangModalLabel">Input Piutang</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('laporan.piutang.biaya') }}" method="POST">
                        @csrf
                        <!-- Form fields for Piutang -->
                    </form>
                </div>
            </div>
        </div>
