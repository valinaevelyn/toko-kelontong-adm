            ...
            <div class="col-md-12 shadow mt-3 p-3 rounded">
                ...
                <form action="{{ route('item.update', $item->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('minimal_stock') is-invalid @enderror"
                            id="minimal_stock" name="minimal_stock"
                            value="{{ old('minimal_stock', $item->minimal_stock) }}">
