            ...
            <form action="{{ route('item.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('stock_dus') is-invalid @enderror" name="stock_dus"
                            value="{{ old('stock_dus') }}">
                        @error('stock_dus')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="stock_rcg" class="form-label">Stock Renceng</label>
                        <input type="number" class="form-control @error('stock_rcg') is-invalid @enderror" name="stock_rcg"
                            value="{{ old('stock_rcg') }}">
                        @error('stock_rcg')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="stock_pcs" class="form-label">Stock PCS</label>
                        <input type="number" class="form-control @error('stock_pcs') is-invalid @enderror" name="stock_pcs"
                            value="{{ old('stock_pcs') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('dus_in_pcs') is-invalid @enderror" name="dus_in_pcs"
                            value="{{ old('dus_in_pcs') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('rcg_in_pcs') is-invalid @enderror" name="rcg_in_pcs"
                            value="{{ old('rcg_in_pcs') }}">
